...
public class NetheriteBombBay extends BombBay {
    public NetheriteBombBay(VehicleEntity entity, ItemStack stack, WeaponMount mount, int slot) {
    ...
    protected Entity getBullet(Vector4f position, Vector3f direction) {
        ...
        String identifier = Config.getInstance().bombBayEntity.getOrDefault(
                string,
                "explosiveaircraft:strong_tnt"
        );
